========================================================================
    ACTIVEX 控件 DLL : SSCARD 项目概述
========================================================================

控件向导已为 SSCARD ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 SSCARD ActiveX 控件 DLL 的每个文件的内容。
...
SSCARDCtrl.h
    此文件包含 CSSCARDCtrl C++ 类的声明。

SSCARDCtrl.cpp
    此文件包含 CSSCARDCtrl C++ 类的实现。

SSCARDPropPage.h
    此文件包含 CSSCARDPropPage C++ 类的声明。

SSCARDPropPage.cpp
    此文件包含 CSSCARDPropPage C++ 类的实现。

CSSCARDCtrl.bmp
    此文件包含一个位图，当 CSSCARDCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 SSCARD.pch 的预编译头 (PCH) 文件和名为 
